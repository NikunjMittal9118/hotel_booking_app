...
const Hotel = () => {
  ...
  console.log(path)
  const {data, loading, reFetch, error} = useFetch(`http://localhost:9000/api/hotels/find/${path[2]}`)
  console.log(data)
  ...
  function daysDifference(date1, date2){
    ...
    const daysDiff = Math.ceil(timeDiff / MILLISECONS_PER_DAY)
    return daysDiff 
  }
    ...
    <div>
      ...
      {loading ? "loading" :
        ...
        <div className="hotelWrapper">
          ...
          <span className="ad">Advertisements</span>
          ...
          <span className="hotelDistance">
            Excellent location – {data.distance} from {data.address}
          </span>
          ...
          <div className="hotelDetails">
            ...
            <div className="hotelDetailsPrice">
              ...
              <span>
                Located in the heart of {data.city}. It is an excellent property with one of the best infrastructure and service.
              </span>
              <h2>
